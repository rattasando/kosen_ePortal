...
export const SCHOLARSHIP_STATUS_COLOR = {
  "กำลังทำงาน":   { color: "bg-amber-100 text-amber-700 border-amber-200",     bar: "bg-amber-400",   dot: "bg-amber-400" },
  "ครบตามสัญญา":  { color: "bg-emerald-100 text-emerald-700 border-emerald-200", bar: "bg-emerald-500", dot: "bg-emerald-500" },
  "ได้รับยกเว้น": { color: "bg-violet-100 text-violet-700 border-violet-200",  bar: "bg-violet-500",  dot: "bg-violet-500" },
};
